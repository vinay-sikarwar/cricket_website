...
import jersy1 from "./assets/merch1.jpg";
import jersy2 from "./assets/merch2.jpg";
import jersy3 from "./assets/merch3.jpg";

export default function Merch() {
  return (
    <section className="min-h-screen bg-[#0e0e0e] px-6 py-24 md:py-32">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        <ShoppingBag className="w-14 h-14 mb-6 text-green-400 animate-bounce" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-full justify-items-center">
          {[jersy1, jersy2, jersy3].map((img, i) => (
            <div
              key={i}
              className="bg-[#1c1c1c] rounded-2xl overflow-hidden shadow-xl hover:shadow-green-500/20 transition duration-300 group w-full max-w-sm"
            >
              <img
                src={img}
                alt={`Official Jersey ${i + 1}`}
